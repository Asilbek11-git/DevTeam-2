...
export const NotificationModal: React.FC<NotificationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-sm flex items-start justify-end p-4">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden mt-12 animate-in fade-in slide-in-from-top-4 duration-150 text-xs">
        {/* Header */}
