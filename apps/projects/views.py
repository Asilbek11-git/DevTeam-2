...
class ProjectViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        return success_response(data=serializer.data, message="Project created successfully", status_code=status.HTTP_201_CREATED)
    ...
    def update(self, request, *args, **kwargs):
        ...
        return success_response(data=serializer.data, message="Project updated successfully")

    @extend_schema(tags=['Projects'])
    def destroy(self, request, *args, **kwargs):
        instance = self.get_object()
        self.perform_destroy(instance)
        return success_response(data=None, message="Project deleted successfully", status_code=status.HTTP_204_NO_CONTENT)
